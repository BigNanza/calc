...
const GSC = (0, util_1.extend)(true, {}, RBY, GSC_PATCH);
const ADV_PATCH = {
...
const ADV = (0, util_1.extend)(true, {}, GSC, ADV_PATCH);
const DPP_PATCH = {
    Aipom: { nfe: true },
    Dusclops: { nfe: true },
    Electabuzz: { nfe: true },
...
const DPP = (0, util_1.extend)(true, {}, ADV, DPP_PATCH);
const BW_PATCH = {
...
const BW = (0, util_1.extend)(true, {}, DPP, BW_PATCH);
...
const XY = (0, util_1.extend)(true, {}, BW, XY_PATCH);
...
const SM = (0, util_1.extend)(true, {}, XY, SM_PATCH);
...
const SS = (0, util_1.extend)(true, {}, SM, SS_PATCH);
...
const SV = (0, util_1.extend)(true, {}, SS, SV_PATCH, PLA_PATCH, ZA_PATCH);
    ...
    constructor(name, data) {
        ...
        if (data.otherFormes) {
            ...
            if (gen >= 9 && !['toxtricity', 'urshifu'].includes(this.id)) {
                ...
                if (this.otherFormes)
                    this.otherFormes = [...new Set(this.otherFormes)];
            }
        }
...
const SPECIES_BY_ID = [];
let gen = 0;
for (const species of exports.SPECIES) {
    const map = {};
